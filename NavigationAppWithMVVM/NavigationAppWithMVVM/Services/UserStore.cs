...
namespace NavigationAppWithMVVM.Services
{
    public static class UserStore
    {
        private static string GetFilePath()
        {
            ...
            string appFolder = Path.Combine(folder, "NavigationAppWithMVVM");
        ...
        //Reads all the users from the json file 
        ...
        //this will save all the users to the json file
